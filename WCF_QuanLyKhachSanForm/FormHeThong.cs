...
using WCF_QuanLyKhachSanForm.ServiceReferenceHeThong;
...
namespace WCF_QuanLyKhachSanForm
{
    public partial class FormHeThong : Form
    {
        ...
        ServiceHeThongClient client = new ServiceHeThongClient();
        HeThongDTO htDTO;
        ServiceNhanVienClient client1 = new ServiceNhanVienClient();
        public FormHeThong()
        {
            InitializeComponent();
        }
