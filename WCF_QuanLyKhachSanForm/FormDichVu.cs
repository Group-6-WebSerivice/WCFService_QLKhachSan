...
namespace WCF_QuanLyKhachSanForm
{
    public partial class FormDichVu : Form
    {
        ...
        ServiceDichVuClient client = new ServiceDichVuClient();
        DichVuDTO dvDTO;
       // public FormPhieuThuePhong frmThue;
        ...
        private void show_DichVu()
        {
            ...
            IList<DichVuDTO> listDV = client.getListDichVuAll();
            cmbDVtinh.Items.Clear();
        ...
        private void show_lcdichvu(string chuoi)
        {
            ...
            IList<DichVuDTO> listdv = client.getLikeDichVuByID(chuoi);
            if (listdv.Count <= 0)
            {
                listdv = client.getListLikeDichVuByName(chuoi);
            }
            foreach(DichVuDTO dv in listdv)
            {
                int i = lsvDichVu.Items.Count;
